...
// ktra
Route::get('/get-product', [App\Http\Controllers\ShowSP::class, 'getProducts']);

Route::get('/get-product/{id}', [App\Http\Controllers\ShowSP::class, 'getOneProduct']);

Route::post('/add-product', [App\Http\Controllers\ShowSP::class, 'addProduct']);

Route::post('/upload-image',[App\Http\Controllers\ShowSP::class,'uploadImage']);								
Route::delete('/delete-product/{id}',[App\Http\Controllers\ShowSP::class,'deleteProduct']);
